<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="ListDetails.aspx.cs" Inherits="S410127183_1.ListDetails" %>
            ...
            <asp:Panel ID="DetailsPanel" runat="server">
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="DetailsDataSource" RenderOuterTable="false"
                    ...
                    <ItemTemplate>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton runat="server" CommandName="Edit" Text="編輯" />
                                <asp:LinkButton runat="server" CommandName="Delete" Text="刪除"
                                    OnClientClick='return confirm("Are you sure you want to delete this item?");' />
                                <asp:LinkButton runat="server" CommandName="New" Text="新增" />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <EditItemTemplate>
